<script setup>
// 统一线性图标（lucide 风格，stroke 2px，继承 currentColor）
...
const ICONS = {
  ...
  book_marked: '<path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H20v20H6.5a2.5 2.5 0 0 1 0-5H20"/><path d="M10 2v8l3-3 3 3V2"/>',
...
<template>
  <svg :width="size" :height="size" viewBox="0 0 24 24" fill="none" stroke="currentColor"
    stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="app-icon"
    v-html="ICONS[name] || ''" aria-hidden="true" />
</template>

<style scoped>
.app-icon { flex-shrink: 0; vertical-align: -0.18em; }
</style>
